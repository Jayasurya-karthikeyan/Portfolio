export const SkillsData = [
  {
    ...
    list: [
      ...
      },
      {
        name: "TypeScript",
        prof: "75%",
        icon: <i class="devicon-typescript-original colored"></i>,
      },
      // {
      //   name: "Sass",
  ...
  //     {
  //       name: "Tesseract",
  //       img: "https://upload.wikimedia.org/wikipedia/commons/7/78/Tesseract_OCR_logo_%28Google%29.png",
  //     },
  //   ],
  // },
  // {
  //   type: "AI/ML Libraries",
  //   list: [
  //     {
  //       name: "OpenCV",
  //       prof: "25%",
  ...
  // },
  {
    ...
    list: [
      ...
      },
      {
        name: "After Effects",
        prof: "65%",
        img: "https://seeklogo.com/images/A/adobe-after-effects-logo-960B473FE4-seeklogo.com.png",
      },
      {
        name: "MS Excel",
        prof: "40%",
